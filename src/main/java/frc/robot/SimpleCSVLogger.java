...
/*
 * This is a simpler adaptation of the simpleCSVLogger by team 1736. Original copyright is below
 *
 *******************************************************************************************
...
public class SimpleCSVLogger {
    ...
    String output_dir = "/U/data_captures/"; // USB drive is mounted to /U on roboRIO; data_captures directory must
                                             // exist
    ...
    public int init(String[] data_fields, String[] units_fields) {
        ...
        // Catch ALL the errors!!!
            ...
            Constants.RobotProperties.robotLogging = false; // turn off robot logging if cannot open a log file
            return -1;
        }
     ...
     * @return 0 on write success, -1 on failure, -2 on Logging turned off.
     */
    public int writeData(String... data_elements) {

        // If logging is disabled, do not write anything; this way I do not need to do
        // an IF for each write
        ...
        try {
            ...
            // End of line
            line_to_write = line_to_write.concat(getDateTimeString() + ", "); // may need to comment this line if
                                                                              // performance suffers
